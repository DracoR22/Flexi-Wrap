...
import { getPaymentStatus } from "@/actions/checkout-actions"
         ...
         <div className="mt-10 border-t border-zinc-200">
            <div className="mt-10 flex flex-auto flex-col">
                 ...
                 <p className="mt-2 text-sm text-zinc-600">
                    We at FlexiWrap believe that a phone case doesn&apos;t only need
                    to look good, but also last you for the years to come. We
                    offer a 5-year print guarantee; I your case isn&apos;t of the highest

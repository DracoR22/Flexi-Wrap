...
if (color === 'blue') {
  ...
  caseBackgroundColor = 'bg-violet-900';
} else if (color === 'orange') {
  caseBackgroundColor = 'bg-orange-950';
} else if (color === 'pink') {
  caseBackgroundColor = 'bg-pink-950';
} else {
  // Default case, if color doesn't match any of the specified cases
  caseBackgroundColor = 'bg-zinc-900'; // or whatever default value you want
}

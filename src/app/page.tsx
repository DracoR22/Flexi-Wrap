...
import { ArrowRightIcon, CheckIcon, PaletteIcon, StarIcon } from "lucide-react";
      ...
      <section>
         <MaxWidthWrapper className="py-24">
            <div className="mb-12 px-6 lg:px-8">
              ...
              <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900">
                Upload your photo and get{' '} <span className="relative px-2 bg-orange-400 text-white rounded-xl">your own case </span>{' '}  now
              </h2>
              </div>
            </div>
            ...
            <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
               <li className="w-fit">
                  <CheckIcon className="h-5 w-5 text-orange-500 inline mr-1.5"/>
